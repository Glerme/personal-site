...
export function HeroSection() {
  ...
  const typewriterTitles = t('data.personalInfo.typewriterTitles', { returnObjects: true }) as string[]
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(0,217,255,0.06) 0%, transparent 70%)',
        }}
        aria-hidden="true"
      />
